...
# Slurm arguments\n\
#\n\
#SBATCH --job-name=cell_mov_pred{extension}            # Name of the job\n\
#SBATCH --export=ALL                # Export all environment variables\n\
#SBATCH --output=cell_mov_pred{extension}.log   # Log-file (important!)\n\
        ...
        for size_of_message in size_of_messages:
            for epoch in epochs:
                with open("slurm_files/cell_mov_pred" + extension + ".sbatch", "w") as f:
                    f.write(slurm_script.format(extension=extension, number_of_messages=number_of_message, size_of_messages=size_of_message, epochs=epoch, distrib="cell_mov_pred"))
